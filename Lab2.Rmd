...
#in console, if you do "summary(mdl1)" it shows the summary of the different coefficents of the model 
```
...
#name of package and then two colons just reminds where that function is comming from 
...
'r equatiomatics::extract_eq(final_mdl, wrap = TRUE, use coefs= TRUE)'
